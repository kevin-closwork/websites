...
const BenefitsSection = () => {
  ...
  const BenefitCard = ({ icon: Icon, title, description, delay }: {
    ...
    <div 
      className="group p-6 rounded-xl bg-card/50 backdrop-blur border border-border/50 hover:border-primary/20 transition-all duration-300 hover:shadow-glow animate-fade-in"
      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              {closerBenefits.map((benefit, index) => (
                <BenefitCard
                  key={benefit.title}
                  icon={benefit.icon}
                  title={benefit.title}
