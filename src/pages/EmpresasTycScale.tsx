        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mt-4 inline-block px-6 py-2 bg-gradient-to-r from-purple-600 to-purple-800 rounded-full">
              <p className="text-lg font-semibold text-white">$2,300 MXN /mes</p>
            </div>
          ...
          <Card className="mb-8 border-2 border-purple-600 bg-gradient-to-br from-purple-600/10 to-purple-800/10">
            <CardHeader>
              <CardTitle className="text-xl text-purple-600">Plan Scale - $2,300 MXN/mes</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="max-h-[600px] overflow-y-auto pr-4 space-y-6 text-sm leading-relaxed">
                ...
                <div>
                  ...
                  <h4 className="font-semibold text-sm mb-2 mt-3">4.1 Plan Scale - $2,300 MXN/mes</h4>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li>3 socios comerciales simultáneamente activos</li>
                    <li>Garantía de servicio mensual (ver Sección 5)</li>
                    <li>Garantía de satisfacción (mínimo 3 meses de uso continuo)</li>
                    <li>Auditoría de Ventas Mensual: Sesión consultiva con tus socios comerciales para buscar mejoras</li>
                    <li>Prioridad VIP: Asignación de nuevos socios comerciales en &lt; 48 horas</li>
                    <li>Soporte prioritario vía WhatsApp Business (&lt;4h respuesta)</li>
                    <li>Acceso a eventos y capacitaciones Closwork</li>
                  </ul>
                  <p className="mt-2"><em>Ideal para: Empresas que buscan máximo rendimiento y escalabilidad con múltiples socios comerciales y soporte prioritario.</em></p>

                  <h4 className="font-semibold text-sm mb-2 mt-4">4.2 Términos de Pago y Renovación</h4>
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li><strong>Primer Pago:</strong> Al contratar el Plan, el Cliente paga $2,300 MXN correspondientes al primer mes de servicio</li>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li>Se suspenden sesiones consultivas y auditorías</li>
                    <li>Se pierde prioridad VIP en matching</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li>Mantenimiento de 3 socios comerciales activos en tu cuenta</li>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li>Auditoría de Ventas Mensual (debe agendarse con mínimo 48hrs de anticipación)</li>
                    <li>Respuesta en WhatsApp Business en máximo 4 horas hábiles</li>
                    <li>Asignación VIP de nuevos socios en máximo 48 horas</li>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li>Proceso de nuevo matching en máximo 48 horas (prioridad VIP)</li>
                  </ul>
                  ...
                  <ol className="list-decimal list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li>Si procede: nuevo matching en 48 horas (prioridad VIP)</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li>✓ Garantía de Satisfacción (solo Plan Scale): Reembolso del 100% si después de mínimo 3 meses consecutivos de uso activo y pago al corriente no estás satisfecho con los resultados obtenidos</li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li>Acepta que NO hay reembolsos por insatisfacción con resultados de ventas (excepto garantía de satisfacción después de 3 meses)</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li><strong>Tiempo de respuesta:</strong> Máximo 24 horas hábiles (Plan Scale: &lt;4 horas vía WhatsApp)</li>
