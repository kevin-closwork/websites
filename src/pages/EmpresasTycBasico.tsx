...
const EmpresasTycBasico = () => {
  ...
  const title = "Términos y Condiciones - Plan Básico | Closwork";
  const description = "Acepta los términos y condiciones para contratar el Plan Básico en Closwork.";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirigir al link de Stripe del Plan Básico
      const stripeUrl = getStripeCheckoutUrl("planBasico");
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta property="og:url" content="/empresas-tyc-basico" />
      </Helmet>
      ...
      <main className="container py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl font-semibold text-muted-foreground">Plan Básico - Closwork para Empresas</h2>
            <div className="mt-4 inline-block px-6 py-2 bg-primary/10 rounded-full">
              <p className="text-lg font-semibold text-primary">$899 MXN /mes</p>
            </div>
          ...
          <div className="mb-8 p-6 bg-gradient-to-r from-[#003976] to-[#1a4a7a] rounded-xl shadow-lg border-2 border-[#003976]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/95 text-base leading-relaxed">
                  Para continuar con tu compra del <strong>Plan Básico</strong>, es necesario que leas y aceptes nuestros términos y condiciones de servicio. 
          ...
          <Card className="mb-8 border-2 border-primary">
            <CardHeader>
              <CardTitle className="text-xl text-primary">Plan Básico - $899 MXN/mes</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="max-h-[600px] overflow-y-auto pr-4 space-y-6 text-sm leading-relaxed">
                ...
                <div>
                  ...
                  <h4 className="font-semibold text-sm mb-2 mt-3">4.1 Plan Básico - $899 MXN/mes</h4>
                  ...
                  <p className="mt-2"><em>Ideal para: Empresas que están comenzando o validando su modelo de ventas externas.</em></p>

                  <h4 className="font-semibold text-sm mb-2 mt-4">4.2 Términos de Pago y Renovación</h4>
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li><strong>Primer Pago:</strong> Al contratar el Plan, el Cliente paga $899 MXN correspondientes al primer mes de servicio</li>
                ...
                <div>
                  ...
                  <p className="mt-2"><strong>✅ Acceso continuo a Socio Comercial asignado:</strong></p>
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li>Mantenimiento de 1 socio comercial activo en tu cuenta</li>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    <li>Sesión consultiva inicial (debe agendarse con mínimo 48hrs de anticipación)</li>
          ...
          <Card className="border-2 border-primary">
            <CardHeader>
              <CardTitle className="text-xl text-primary">Formulario de Aceptación - Plan Básico</CardTitle>
            </CardHeader>
            <CardContent>
...
export default EmpresasTycBasico;
